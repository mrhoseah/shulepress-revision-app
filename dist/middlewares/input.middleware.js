...
const formidableMiddleware = (0, express_formidable_1.default)();
const parseFormData = (req, res, next) => {
    formidableMiddleware(req, res, next);
};
exports.parseFormData = parseFormData;
const validateInput = (schema) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
//# sourceMappingURL=input.middleware.js.map